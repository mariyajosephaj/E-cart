...
const Cart = () => {
  ...
  const checkout = ()=>{
    dispatch(emptyCart())
    alert("your order confirmed ... thank you for purchaising with us")
    // redirect to home
    navigate("/")
  }
  return (
      ...
      <div className="col-span-2 border rounded p-5 shadow">
        <table className="table-auto w-full">
          ...
          <tr>
              <td>{index+1}</td>
              <td>{product?.title}</td>
              <td><img src={product?.thumbnail} width={'70px'} height={'70px'} alt="" /></td>
              <td>
                <div className="flex">
        ...
        <div className="float-right mt-5">
          <button onClick={()=>dispatch(emptyCart())} className="bg-red-600 rounded p-2">EMPTY CART</button>
